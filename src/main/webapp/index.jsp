...
<div class="container">
    <div class="row">
        <ul class="nav">
            ...
            <li class="nav-item">
                <a class="nav-link" href="<%=request.getContextPath()%>/posts.jsp">Добавить вакансию</a>
            </li>
            <li class="nav-item">
    ...
    <div class="row">
        <div class="card" style="width: 100%">
            <div class="card-header">
                <ul class="nav">
                    <li class="nav-item">
                        <a class="nav-link" href="<%=request.getContextPath()%>/posts.jsp">Сегодняшние вакансии.</a>
                    </li>
                </ul>
            </div>
            <div class="card-body">
